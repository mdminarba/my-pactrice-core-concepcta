...
const Country = ({country,handleVisittedCountris, handleVisittedCountrisflag}) => {
    ...
    return (
           ...
           <button onClick={() =>handleVisittedCountrisflag(country.flags.png)} className="btn btn-secondary my-4">Add Flag</button> <br />
